    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900">{t('tools.title', 'Longevity Tools')}</h2>
          <Link href={`/${locale}/tools`} className="text-teal-600 hover:text-teal-800 font-medium">
            {t('tools.viewAll', 'View All Tools')}
          </Link>
        </div>
